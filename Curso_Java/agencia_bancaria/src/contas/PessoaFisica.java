...
public class PessoaFisica {
	...
	public static void main(String[] args) {
		...
		System.out.println("Cliente: R$ " + cc1.getCliente());
		System.out.println("Favorecido: R$ " + cc2.getCliente());
		...
		System.out.println("------------------------------");
		System.out.println("");
		System.out.println("Cliente: R$ " + cc2.getCliente());
		cc2.exibirSaldo();
